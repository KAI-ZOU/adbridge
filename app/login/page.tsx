        ...
        <div className="max-w-md mx-auto">
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 rounded-2xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-white/70">Sign in to your AdBridge account</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:border-[#8ef0a7] pr-10"
                      required
                    />
                    <Button
                      type="button"
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-[#8ef0a7] hover:bg-[#7de096] text-black font-semibold"
                >
                  {isLoading ? (
                    <>
              ...
              <div className="text-center text-sm text-white/60">
                ...
                <Link href="/signup" className="text-[#8ef0a7] hover:underline font-medium">
                  Sign up
                </Link>
              </div>
